            ...
            ->columns([
                ...
                TextColumn::make('alert')
                    ->state(function (Product $record): string {
                        $beli = OrderItem::where('product_id', $record->id)->where('mutation_type', 'Purchase')->sum('total_amount');
                        $jual = OrderItem::where('product_id', $record->id)->where('mutation_type', 'Sales')->sum('total_amount');
