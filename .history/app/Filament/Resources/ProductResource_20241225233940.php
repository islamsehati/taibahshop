                ...
                Group::make()->schema([
                    Section::make('Product Information')->schema([
                        ...
                        Select::make('contain')
                            ->multiple()
                            ->searchable()
                            ->getOptionLabelFromRecordUsing(fn(Product $record) => "{$record->name} {$record->variant} Rp" . Number::format($record->price, locale: 'de'))
