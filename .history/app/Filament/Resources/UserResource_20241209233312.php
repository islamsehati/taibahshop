            ...
            ->schema([
                ...
                Select::make('city')
                    ->options(function (Get $get): SupportCollection {
                        return City::query()->orderBy('name', 'DESC')->where('province_code', $get('state'))->pluck('name', 'code');
                    })
                    ->searchable()
                    ->required()
                    ->live()
                ...
                Select::make('district')
                    ->options(function (Get $get): SupportCollection {
                        return District::query()->orderBy('name', 'DESC')->where('city_code', $get('city'))->pluck('name', 'code');
                    })
                    ->searchable()
                    ->required()
                    ->live()
                ...
                Select::make('village')
                    ->options(function (Get $get): SupportCollection {
                        return Village::query()->orderBy('name', 'DESC')->where('district_code', $get('district'))->pluck('name', 'code');
                    })
                    ->searchable()
                    ->required(),
