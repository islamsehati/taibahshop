            ...
            ->schema([
                ...
                Select::make('city')
                    ->options(function (Get $get): SupportCollection {
                        return City::query()->where('province_code', $get('state')->sortBy('name'))->pluck('name', 'code');
                    })
                    ->searchable()
                    ->required()
                    ->live()
                ...
                Select::make('district')
                    ->options(function (Get $get): SupportCollection {
                        return District::query()->where('city_code', $get('city')->sortBy('name'))->pluck('name', 'code');
                    })
                    ->searchable()
                    ->required()
                    ->live()
                ...
                Select::make('village')
                    ->options(function (Get $get): SupportCollection {
                        return Village::query()->where('district_code', $get('district')->sortBy('name'))->pluck('name', 'code');
                    })
                    ->searchable()
                    ->required(),
