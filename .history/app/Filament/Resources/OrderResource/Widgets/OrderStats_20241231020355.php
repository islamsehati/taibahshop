...
class OrderStats extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $incOrDecPaid = ($paid_chart2 >= $paid_chart3) ? 'increase' : 'decrease';
        $incOrDecPaidColor = ($paid_chart2 >= $paid_chart3) ? 'info' : 'danger';
        $incOrDecPaidIcon = ($paid_chart2 >= $paid_chart3) ? 'heroicon-m-arrow-trending-up' : 'heroicon-m-arrow-trending-down';
        $incOrDecPaidPersen = Number::percentage((($paid_chart2 - $paid_chart3) / $paid_chart3) * 100, maxPrecision: 2);
