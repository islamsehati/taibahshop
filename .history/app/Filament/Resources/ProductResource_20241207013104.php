            ...
            ->columns([
                ...
                TextColumn::make('stock')
                    ->state(function (Product $record): string {
                        ...
                        $beli = $orderitems->where('product_id', $record->id)->where('mutation_type', 'Purchase')->sum('p_quantity');
                        $jual = $orderitems->where('product_id', $record->id)->where('mutation_type', 'Sales')->sum('quantity');
                        $hasil = $beli - $jual;
                        return $hasil;
                    }),
