            ...
            ->columns([
                ...
                TextColumn::make('stock')
                    ->state(function (Product $record): string {
                        $orderitems = OrderItem::all()->leftJoin('orders', 'order_items.id', '=', 'orders.id')->leftJoin('porders', 'order_items.id', '=', 'porders.id')->get()->where('order.status', '!=', 'canceled')->where('porder.status', '!=', 'canceled');
