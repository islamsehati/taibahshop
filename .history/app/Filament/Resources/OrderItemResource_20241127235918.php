    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                ...
                Filter::make('sales_not_canceled')
                    ->query(fn(Builder $query): Builder => $query->where('order.status', '!=', 'canceled')),
                Filter::make('purchase_not_canceled')
                    ->query(fn(Builder $query): Builder => $query->where('porder.status', '!=', 'canceled')),
            ])
            ->actions([
