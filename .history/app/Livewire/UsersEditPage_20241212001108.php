...
class UsersEditPage extends Component
{
    ...
    {
        $this->name = User::where('id', $id)->value('name');
        $this->phone = User::where('id', $id)->value('phone');
        $this->email = User::where('id', $id)->value('email');

        $this->street_address = User::where('id', $id)->value('street_address');
        $this->zip_code = User::where('id', $id)->value('zip_code');
    }
