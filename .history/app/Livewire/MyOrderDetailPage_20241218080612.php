...
class MyOrderDetailPage extends Component
{
    ...
    {
        // $this->order = $order;
        $user_id = Order::where('id', $order)->value('user_id');
    ...
    {
        $order_items = OrderItem::with('product')->where('order_id', $order)->get();
        $paymentslast = Payment::where('order_id', $order)->latest()->first();
        $address = Address::where('order_id', $order)->first();
        $address_firstname = Address::where('order_id', $order)->value('first_name');
        $address_lastname = Address::where('order_id', $order)->value('last_name');
