...
class ItemsPage extends Component
{
    ...
    public function render()
    {
        ...
        $orderitems = OrderItem::leftJoin('orders', 'order_items.id', '=', 'orders.id')->leftJoin('porders', 'order_items.id', '=', 'porders.id')->where('order.status', '!=', 'canceled')->where('porder.status', '!=', 'canceled');
