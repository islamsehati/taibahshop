...
class MyOrderDetailPage extends Component
{
    ...
    public function editPayment($idpay)
    {
        ...
        if ($payment_method_edit = 'transfer' && ($grand_total >= $this->input_payment_edit)) {
            $input_payment_edit = $grand_total / 1;
        } elseif ($payment_method_edit = 'transfer' && ($grand_total < $this->input_payment_edit)) {
            $input_payment_edit = $this->input_payment_edit;
        } elseif ($payment_method_edit = 'cash' && ($grand_total >= $this->input_payment_edit)) {
            $input_payment_edit = $this->input_payment_edit;
        } elseif ($payment_method_edit = 'cash' && ($grand_total < $this->input_payment_edit)) {
            $input_payment_edit = $this->input_payment_edit;
        } else {
