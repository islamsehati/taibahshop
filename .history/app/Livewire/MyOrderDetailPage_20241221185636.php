...
class MyOrderDetailPage extends Component
{
    ...
    public function editPayment($idpay)
    {
        ...
        $grand_total = $data->value('grand_total') / 1;
        ...
        if ($payment_method_edit = 'transfer' && $this->input_payment_edit >= $grand_total) {
            $input_payment_edit = $grand_total;
        } elseif ($payment_method_edit = 'transfer' && $this->input_payment_edit < $grand_total) {
            $input_payment_edit = $this->input_payment_edit;
        } elseif ($payment_method_edit = 'cash' && $this->input_payment_edit >= $grand_total) {
            $input_payment_edit = $grand_total;
        } elseif ($payment_method_edit = 'cash' && $this->input_payment_edit < $grand_total) {
            $input_payment_edit = $this->input_payment_edit;
        } elseif ($this->input_payment_edit == null && $payment_method_edit = 'cash') {
            $input_payment_edit = $grand_total;
        } elseif ($this->input_payment_edit == null && $payment_method_edit = 'transfer') {
            $input_payment_edit = $this->input_payment_edit;
        } else {
