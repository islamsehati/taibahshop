...
class ProductsExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function map($product): array
    {
        ...
        $stokterkini = $orderitems->where('product_id', $product->id)->sum('p_quantity') - $orderitems->where('product_id', $product->id)->sum('quantity');
        return [
            ...
            $product->in_stock,
            $product->on_sale,
            $orderitems->where('product_id', $product->id)->sum('p_quantity'),
            $orderitems->where('product_id', $product->id)->sum('quantity'),
