...
{{ request()->is('cart')?' hidden' : ''}} 
 {{ request()->is('checkout')?' hidden' : ''}}
  ">
    ...
    <div class="fixed z-50 w-full mx-3 h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
