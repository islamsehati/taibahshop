            ...
            <div class="flex flex-wrap mb-10 -mx-3">
                ...
                <div class="w-full">
                    ...
                    <div class="px-3 mb-4 ">
                        <div class="items-center justify-between px-3 py-2 bg-gray-50 md:flex dark:bg-gray-900 ">
                                                ...
                                                <ul class="space-y-1 border-t border-gray-200 p-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input type="range" wire:model.live="price_range"
                                                            ...
                                                            max="150000" value="150000" step="10000">
                                                        <div class="flex justify-between ">
                                                            <span
                                                                class="inline-block text-sm font-bold text-blue-400 ">@currency(10000)</span>
                                                            <span
                                                                class="inline-block text-sm font-bold text-blue-400 ">@currency(150000)</span>
                                                        </div>
                                                    </div>
                            ...
                            <div wire:ignore class="max-md:mt-2 w-1/4 max-md:w-full">
                                <select wire:change='changeBranch()' wire:model.live='branch'
                    ...
                    "hasSearch": true,
                                    ...
                                    @foreach ($branches as $branch)
                                        <option value="{{ $branch->id }}"
                                          ...
                                          "icon" : "<img src=\"{{url('storage', $branch->image)}}\" class=\"object-cover object-center w-5 h-5\" />"
                                          }'>
                                             {{ $branch->name }} - {{ $branch->phone }} . PHP_EOL . {{ $branch->street_address }}
                                            </option> 
                                    @endforeach
                                </select>
                            </div>
                  ...
                  @endphp --}}
                                        ...
                                        @else
                                            <a
                                                class="cursor-not-allowed text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300"><span>Habis</span></a>
                                        @endif
