          ...
          <div class="p-4 sm:p-7">
            ...
            <form wire:submit.prevent='login'>
              ...
              <div class="grid gap-y-4">
                ...
                <a wire:navigate class="text-center text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/forgot">Forgot password?</a>
              </div>
            </form>
            <!-- End Form -->
          </div>
