...
const imagePreview = ref(props.brand.image ?? null)
...
function submit() {
  ...
  router.post(`/merk/${props.brand.id}`, data, {
    preserveScroll: true,
    onSuccess: () => console.log('Merk berhasil diperbarui'),
    onError: (errors) => console.log(errors),
  })
}

const breadcrumbs = [
  { title: 'Ubah Merk', href: `/merk/${props.brand.id}/edit` },
]
</script>
