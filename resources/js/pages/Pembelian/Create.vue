...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Buat Pembelian', href: '/pembelian/buat/baru' }
];
...
// Submit form
const submit = () => {
  router.post('/pembelian/store', form.value, {
    onSuccess: () => {
    ...
    <div class="p-3 mx-auto space-y-4 w-full max-w-2xl">
      <Card>
        ...
        <CardContent class="space-y-4">
          ...
          <!-- Tipe Pembelian -->
          <div>
            <label class="text-sm">Tipe Pembelian</label>
          ...
          <div class="flex justify-end gap-2">
            ...
            <Button @click="submit" :disabled="isGeneralCustomer && form.user_alias === ''">Buat Pembelian</Button>
          </div>
