    ...
    <div class="relative">
      ...
      >
        ...
        >
          ...
          <!-- Laporkan Produk -->
          <a
            :href="`https://wa.me/6289684561000?text=Saya%20ingin%20melaporkan%20produk%20berikut:%0A${produk.name}%20milik%20store%20${produk.branch.name}%0Adapatin.id/product/${produk.slug}`"
            target="_blank"
            @click="closeWaMenu"
