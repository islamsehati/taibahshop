<header class="{{ request()->is('pos') || request()->is('mypos') || request()->is('produk')  ?'hidden' : 'flex'}} {{ request()->is('checkout')?'hidden' : 'flex'}}   
  ...
  <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
    ...
    {{ request()->is('my-account')?'hidden' : 'relative'}} 
      ...
      <div class="flex items-center justify-between">
        ...
        <a wire:navigate class="flex-none text-xl font-lobster text-yellow-400 dark:text-yellow-400" aria-label="Brand">TaibahShop</a>
        <a wire:navigate class="flex-none text-xl font-lobster text-yellow-400 dark:text-yellow-400 ml-3" onclick="location.href='javascript:history.back();'" wire:navigate><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i></a>       
        @elseif (auth()->check() && auth()->user()->is_admin == 0 && strpos(url()->full(),'products/') != false)
        <a wire:navigate class="flex-none text-xl font-lobster text-yellow-400 dark:text-yellow-400" aria-label="Brand">TaibahShop</a>
        <a wire:navigate class="flex-none text-xl font-lobster text-yellow-400 dark:text-yellow-400 ml-3" href="/products" wire:navigate><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i></a>       
        @else
        <a wire:navigate class="flex-none text-xl font-lobster text-yellow-400 dark:text-yellow-400" href="/" aria-label="Brand">TaibahShop</a>
        @endif
      ...
      <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
          <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700 pr-3">
            ...
            <a wire:navigate class="font-medium {{ request()->is('/')?' text-yellow-400' : 'text-white'}} hover:lg:text-red-500 hover:lg:bg-yellow-500 hover:lg:h-2 hover:lg:pt-1 hover:lg:px-3 hover:lg:-mx-3  hover:rounded-lg py-3 md:py-6 dark:text-white dark:hover:text-gray-500" href="/" aria-current="page">Home</a> 
            ...
            <a wire:navigate class="font-medium {{ request()->is('my-orders')?' text-yellow-400' : 'text-white'}}  hover:lg:text-red-500 hover:lg:bg-yellow-500 hover:lg:h-2 hover:lg:pt-1 hover:lg:px-3 hover:lg:-mx-3  hover:rounded-lg py-3 md:py-6 dark:text-white dark:hover:text-gray-500" href="/my-orders">
              My Orders
            </a>
            ...
            <div class="pt-3 md:pt-0">
              <a wire:navigate class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-yellow-400 text-white hover:bg-yellow-500 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/login">
                <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" />
                  <circle cx="12" cy="7" r="4" />
                </svg>
            ...
            <div class="hs-dropdown [--strategy:static] md:[--strategy:fixed] [--adaptive:none] md:[--trigger:hover] max-md:pt-3 md:py-5 hover:text-white hover:lg:bg-yellow-500 hover:lg:h-2 hover:lg:pt-3 hover:lg:pb-8 hover:lg:px-3 hover:lg:-mx-3 hover:rounded-lg">
              ...
              <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">
                ...
                <a href="/mypos" class="{{ auth()->user()->is_admin == 1 ?'block' : 'hidden'}} flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                  POS <i class="fa fa-fax" aria-hidden="true"></i>
                </a>
                <a wire:navigate href="/items" class="{{ auth()->user()->is_admin == 1 ?'block' : 'hidden'}} flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                  Items List <i class="fa fa-list" aria-hidden="true"></i>
                </a>
                <a wire:navigate href="/payments" class="{{ auth()->user()->is_admin == 1 ?'block' : 'hidden'}} flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                ...
                <a wire:navigate class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/logout">
  ...
  <nav class="{{ request()->is('produk')? 'hidden' : 'fixed '}} md:hidden bottom-0 left-0 z-50 w-full h-10 bg-gray-800 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
      
      <a wire:navigate href="/" class="inline-flex flex-col items-center justify-center px-5 pr-3.5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
      ...
      <a wire:navigate href="/categories" class="inline-flex flex-col items-center justify-center px-5 pr-3.5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
      ...
      href="/products?branch=1" 
      @endguest
      class="inline-flex flex-col items-center justify-center px-5 pr-3.5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
      ...
      <a wire:navigate href="/my-orders" class="inline-flex flex-col items-center justify-center px-5 pr-3.5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
      ...
      <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 px-2 py-2 bg-white shadow-md rounded-lg mt-2 dark:bg-neutral-800 dark:border dark:border-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-dropup">
        ...
        <div class="p-1 space-y-0.5">
          ...
          <a wire:navigate class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
          href="/branches">
          Cabang <i class="fa fa-map-marker" aria-hidden="true"></i>
          </a>
          <a wire:navigate class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
          ...
          @guest
          <a wire:navigate class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/login">
            Masuk <i class="fa fa-sign-in" aria-hidden="true"></i>
          </a>
          @endguest
          @auth
          <a wire:navigate class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700" href="/logout">
            Keluar <i class="fa fa-sign-out" aria-hidden="true"></i>
          </a>
          @endauth
        </div>
