    ...
    <div class="w-full md:h-screen h-800 bg-gradient-to-r from-yellow-300 to-red-400 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 class="block text-4xl font-bold text-gray-800 dark:text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">Cicipi menu lezat bersama <span class="text-red-500">Taibah</span></h1>
              <p class="mt-3 text-lg text-gray-800 dark:text-gray-800">Cita rasa ayam goreng gurih bikin nagih. Balutan tepung yang premium dan spicy. "Rasakan nikmatnya penuh berkah".</p>
              ...
              <div class="mt-7 grid gap-3 w-full sm:inline-flex">
                ...
                @endguest
                class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-yellow-500 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-yellow-500">
                  Get started
                  <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="m9 18 6-6-6-6" />
                  </svg>
                </a>
                <a wire:navigate href="/categories" class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-yellow-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:hover:border-yellow-500 dark:text-white dark:hover:bg-yellow-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-yellow-500">
                  Special Offer 
                </a>
              </div>
              <!-- End Buttons -->
              ...
              <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                ...
                <div class="py-5">
                  <div class="flex space-x-1">
                    <svg class="h-4 w-4 text-gray-800 dark:text-gray-800" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p class="mt-3 text-sm text-gray-800 dark:text-gray-800">
                    <span class="font-bold">4.8</span> /5 - from 29 reviews
                  </p>
      
                  <div class="mt-5">
                    <!-- Star -->
                    <svg class="h-auto w-16 text-gray-800 dark:text-gray-800" width="80" height="27" viewBox="0 0 80 27" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <section class="group py-20">
        <div class="group-hover:animate-slidein600 max-w-xl mx-auto">
          <div class="text-center ">
            ...
            <p class="mb-12 text-base text-center text-gray-500 dark:text-gray-400 mx-4">
              Beberapa Brand unggulan tersedia. <a href="/categories" class="text-red-500">Selengkapnya...</a>
            </p>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 max-lg:grid-cols-2">
            ...
            <div wire:key="{{ $brand->id }}" class="group/brand bg-white rounded-lg shadow-sm hover:shadow-lg dark:bg-gray-800">
              <a href="/products?selected_brands[0]={{ $brand->id }}" class="">
                <img src="{{ Str::replace('%2F', '/',url('storage', $brand->image)) }}" alt="{{ $brand->name }}" class="object-contain aspect-square w-full mx-auto rounded-t-lg scale-90">
              </a>
      ...
      <section class="bg-orange-200 dark:bg-yellow-900 py-20 group">
        <div class="group-hover:animate-slidein600 max-w-xl mx-auto">
          <div class="text-center ">
            <div class="relative flex flex-col items-center">
            ...
            <p class="mb-12 text-base text-center text-gray-500 dark:text-gray-400 mx-4">
              Pilih kategori yang kamu mau. <a href="/categories" class="text-red-500">Selengkapnya...</a>
            </p>
          </div>
        </div>
              ...
              <div class="p-4 md:p-5">
                <div class="flex justify-between items-center">
                  <div class="flex items-center">
                    <img src="{{ Str::replace('%2F', '/',url('storage', $category->image)) }}" alt="{{ $category->name }}" class="h-[2.375rem] w-[2.375rem] rounded-full">
