          ...
          <form wire:submit.prevent='updateMyAccount'>
            ...
            <div class="grid lg:grid-cols-2 gap-y-4 gap-x-4">
              ...
              <div >
                ...
                <a href="/my-account" class="w-full mt-3 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-gray-400 text-white hover:bg-red-400 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                  Batal
                </a>
              </div>
