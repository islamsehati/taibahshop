...
class ProductsPage extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->page == "" && $this->cari == null && $this->selected_categories == null && $this->selected_brands == null && $this->featured == null && $this->promo == null && $this->price_range == 150000) {
            $url = 0;
        } else {
            $url = 1;
        }
        ...
        return view('livewire.products-page', [
            'products' => $productQuery->paginate(10000)->withQueryString(),
