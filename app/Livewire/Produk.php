...
class Produk extends Component
{
    ...
    public function triggerLoadCartDesktop()
    {
        $this->dispatch('loadCartDesktop'); // trigger ke JS
    }
    ...
    public function saveCartDesktop($data)
    {
        // $this->cartItems = $data;
        // $this->cartItems = [];
        ...
        return redirect()->to("https://web.whatsapp.com/send?phone=6281370100057&text=" . $encoded_message);
